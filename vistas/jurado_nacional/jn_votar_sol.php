                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="card">
                                ...
                                <div class="content">
                                    <form action='../../controladores/jurado_nacional/ctrl_jn_votar_sol.php' method='post'>
                                        <div class="row">
                                            <!-- Titulo -->
                                            <div class="col-md-4">
                                        ...
                                        <a class="btn btn-info btn-fill pull-left" href="jn_soluciones.php?premio=<?php echo $premio; ?>"><?php echo $idioma['volver'];?></a>
