<!--
======================================================================
Muestra los premios nacionales
                ...
                <div class="content">
                    <div class="container-fluid">
                                        ...
                                        <table class="table table-hover table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="a_pn_mod.php?pn=<?php echo $p['idPremio'];?>"><i class="pe-7s-eyedropper"></i></a></td>
                                                    <td><a href="a_pn_del.php?pn=<?php echo $p['idPremio'];?>"><i class="pe-7s-trash"></i></a></td>
                                                </tr>
                                                <?php } }?>
                                            </tbody>
                                        </table>
                        ...
                        <div class="col-md-3 col-md-offset-5">
                            <a class="boton btn btn-info btn-fill" href="a_pn_nuevo.php"><?php echo $idioma["nuevo_pn"]; ?></a>
                        </div>
                    </div>    
                </div>
